list.of.packages <- c("shiny", "dplyr", "datasets", "leaflet", "stringr", "rjson", "readr", "lubridate", "rgdal", "devtools", 
                      "shinythemes", "rpivotTable", "htmlwidgets", "rpivotTable", "DT")
...
# read main data file
datafile <- data.frame(read_csv(shiny_data_filename, col_types = list(DUNS = col_character(), Control.No. = col_character(), Project.No. = col_character(), Proj.ZIP = col_character(), 
