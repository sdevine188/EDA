...
log <- read.csv("indirect_costs_test.csv", stringsAsFactors = FALSE)
...
for(i in 1:length(log1$grantee_email)){
        ...
        body1 <- ""
        if(log1$type[i] == "Certificate"){
                body1 <- "Hello,\n\nPlease find attached the signed %s %s for %s.  If you have any questions, please don't hesitate to let me know.  Thanks.\n\nStephen Devine\nProgram Analyst\nPerformance and National Programs Division\nEconomic Development Administration\n202-482-9076"
        } else if (log1$type[i] == "Proposal"){
                body1 <- "Hello,\n\nPlease find attached the signed %s %s for %s.  If you accept the approved indirect cost rate, please counter-sign the Acceptance Letter and email me back a scanned copy.  If you have any questions, please don't hesitate to let me know.  Thanks.\n\nStephen Devine\nProgram Analyst\nPerformance and National Programs Division\nEconomic Development Administration\n202-482-9076"
        }
